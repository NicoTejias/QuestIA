    ...
    ws.on('open', () => {
      const code = `
        (async () => {
          ...
          // Find exports of module where b is defined
          const pos = txt.indexOf('b=(0,h.YQ)(y.swQ,g.dZ)');
          const modStart = txt.lastIndexOf('(e,t,r){', pos);
          return txt.substring(modStart, pos + 50);
        })()
      `;
