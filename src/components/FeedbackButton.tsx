...
import { MessageSquare, X, Send, Loader2, AlertCircle, Lightbulb, Heart } from 'lucide-react'
                    ...
                    <div className="relative bg-surface-light border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-slate-400 text-sm mt-1">Ayúdanos a mejorar Quest con tus ideas.</p>
                            </div>
                            <button 
