                ...
                <div className="bg-surface-light border border-white/5 rounded-2xl p-6 hover:border-blue-500/20 transition-all">
                    <h3 className="text-lg font-bold text-white mb-4 flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="text-[10px] bg-white/5 hover:bg-white/10 text-slate-400 px-2 py-1.5 rounded-lg border border-white/5 transition-all flex items-center gap-1.5 font-medium uppercase tracking-wider"
                            title="Limpiar lista"
                        >
